...
#include "f110_msgs/msg/detail/proj_opp_point__rosidl_typesupport_fastrtps_c.h"
...
using _ProjOppPoint__ros_msg_type = f110_msgs__msg__ProjOppPoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ProjOppPoint__ros_msg_type * ros_message = static_cast<const _ProjOppPoint__ros_msg_type *>(untyped_ros_message);
  // Field name: s
  {
    cdr << ros_message->s;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _ProjOppPoint__ros_msg_type * ros_message = static_cast<_ProjOppPoint__ros_msg_type *>(untyped_ros_message);
  // Field name: s
  {
    cdr >> ros_message->s;
  }
...
static uint32_t _ProjOppPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_f110_msgs__msg__ProjOppPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = f110_msgs__msg__ProjOppPoint;
    is_plain =
      (
...
static size_t _ProjOppPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_f110_msgs__msg__ProjOppPoint(
...
static message_type_support_callbacks_t __callbacks_ProjOppPoint = {
  "f110_msgs::msg",
  "ProjOppPoint",
