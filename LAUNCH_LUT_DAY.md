...
🔴 **가장 중요한 한 줄: referee는 블랙박스가 아니다 — 랩을 도는 "동안" 떠 있어야 기록된다.**
주행을 먼저 다 하고 나중에 회수하는 방식이 아니다 (2026-08-13 3차 시도에서 6랩을
referee 없이 주행 → 데이터 0건으로 전량 유실). 랩마다 반드시:
**runner 시작 → "odom 수신 확인" → 조이스틱 A → `lap_complete` 출력 확인 → 다음 랩.**
