...
Confirmed 정적 장애물을 주행 동안 map 좌표로 기억하고, Layer 1 기본 지도와 합성해
`/adaptive_obstacle_map`을 발행하는 ROS 2 Jazzy C++ 패키지다. 저장 장애물은 RViz용
`/adaptive_obstacle_map/markers` (`visualization_msgs/msg/MarkerArray`)로도 발행한다.
