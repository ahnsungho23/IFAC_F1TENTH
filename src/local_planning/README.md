...
방향을 고정합니다.
첫 회피의 merge 뒤에 별도 blocking 군집이 있으면 controller용 global tail 충돌로 첫 경로를
폐기하지 않습니다. 첫 장애물을 완전히 지난 뒤 현재 `ego.d`에서 다음 회피 spline을 직접
연결하며, 중간 global 복귀·빈 경로·불필요한 safe-stop을 만들지 않습니다. 이때 완료된 첫
maneuver의 방향 잠금은 다음 계획에 전달하지 않습니다.
