...
- Repository root `mcl_change.md` is the old-vs-current diff record for the 2026-08-15 overhaul
  (`a37294d` → HEAD): algorithm reorder, executor/callback groups, cluster pose, `/pf/health`,
  lock fixes, parameter and map changes. Update it if that baseline moves.
