...
from trajectory_gui import render_preview_rgb, rgb_to_photoimage


SCRIPT_DIR = Path(__file__).resolve().parent
REPO_ROOT = SCRIPT_DIR.parent
DEFAULT_PARAMS_YAML = SCRIPT_DIR / "forza_gui_params.yaml"
DEFAULT_OPTIMIZER_CONFIG_DIR = (
    REPO_ROOT / "src/global_planning/vendor/gb_optimizer/config/global_planner"
)
VENDOR_SRC = REPO_ROOT / "src/global_planning/vendor/gb_optimizer/src"
HELPER_FUNCS_SRC = (
    VENDOR_SRC
    / "global_racetrajectory_optimization/helper_funcs_glob/src"
)
RACE_STACK_COMMIT = "202450f51081b618fcca71924ad6d33f44f90e44"
OPTIMIZER_COMMIT = "b1b38ecfefec7200d5bcb243f115af1d795b3766"

# The repository vendors the exact optimization submodule revision used by the
# referenced ForzaETH Jazzy branch. Keep it local so this GUI has no ROS runtime
# or separately installed trajectory_planning_helpers dependency.
